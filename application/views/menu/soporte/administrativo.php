                        ...
                        <?php if(count($lista_administrativo)>0):?>
                             <?php foreach ($lista_administrativo as $lp):?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="#modalEditarAdministrativo" data-toggle="modal" class="btn btn-success"><i></i>Editar</a>
                                        <a href="#modalVerAdministrativo" data-toggle="modal" class="btn btn-info"><i></i>Ver</a>
                                    </td>
                                </tr>
                        <?php endforeach;?>
                        <?php endif;?>
